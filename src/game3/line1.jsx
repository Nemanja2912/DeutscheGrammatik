  ...
  const handleMove = (index) => {
    ...
    const move = (e) => {
      ...
      if (
        ...
        wordObj[targetElementIndex].ref.current.style.transition = "0.5s";
        ...
        if (
          ...
          for (let i = 0; i < list.length; i++) {
            if (wordObj[i].side === "right" && i !== targetElementIndex) {
              wordObj[i].ref.current.style.transition = "0.5s";
              wordObj[i].left =
    ...
    const moveEnd = () => {
      ...
      wordObj[elementIndex].ref.current.style.transition = "0.5s";
